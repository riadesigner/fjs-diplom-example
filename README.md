...
Цель дипломного проекта - разработка фронтенд- и бэкенд-части для сайта-агрегатора с реализацией возможности бронирования гостиниц на диапазон дат.

Вам предстоит:
- Разработать пользовательский интерфейс
- Разработать публичный API
- Разработать API пользователя
- Разработать API администратора
- Разработать чат консультанта
...
1. Убедитесь, что на вашем компьютере установлен и доступен перечень фреймворков и программ, необходимых для выполнения задания. 
- React
- Redux
- React Router
- Node.js
