...
- Время, отводимое на дипломную работу, не предполагает существенных усилий по оформлению приложения. По желанию, можно использовать CSS фреймворки типа  Bootstrap, любой Material Design или какой вам интересен (при использовании фреймворка укажите это в Readme.md). Главное, чтобы интерфейс приложения должен быть логичным и интуитивно понятным пользователю, имеющему опыт работы с аналогичными веб-приложениями.
...
![Поиск](assets/page-search.jpg "Поиск номеров")
...
![Поиск](assets/page-hotel-results.jpeg "Выдача результатов поиска")
...
![Изменение описания гостиницы](assets/hotel-edit-page-filled.jpeg "Страница редактирования гостиницы заполненная")
...
![Изменение описания гостиницы](assets/hotel-edit-page-empty.jpg "Страница редактирования гостиницы пустая")
...
![Страница гостиницы](assets/hotel-page.jpg "Страница гостиницы")
